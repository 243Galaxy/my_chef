<div>
    <div class="p-4 sm:ml-64 relative overflow-x-auto shadow-md sm:rounded-lg mt-16">
        ...
        @endif
        <form class="mt-4" wire:submit.prevent="updateFood">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <div>
                    <textarea wire:model="process" class="h-48 text-black" name="content" id="content">
                        {{ $process }}
                    </textarea>
                    @error('process')
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
              ...
              <div class="relative z-0 w-full mb-5 group">
                <input type="file" wire:model="new_picture" name="floating_first_name" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
